export default function NavigationBar() {
  return (
    <nav className="d-flex justify-content-between pe-5 ps-5 py-2 px-2 border-bottom">
      <div className="d-flex jusify-content-between align-items-center gap-3">
        ...
        <a href="/" className="text-decoration-none link-dark fw-bolder fs-4">
          Agriculture 3.0
        </a>
        <span>|</span>
        <a
      ...
      <div className="d-flex gap-4 align-items-center">
        <a href="#" className="nav-link">
          <img
            src="src\assets\svg\shopping_cart.svg"
            alt=""
            width={25}
            height={25}
          />
        ...
        <button
          type="button"
          className="btn btn-dark p-2 ps-4 pe-4 fw-bolder fs-6"
        >
          Login
        </button>
      </div>
