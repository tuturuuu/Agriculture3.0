...
export default function Carousel({ mockData, CardComponent, carouselId }) {
    ...
    return (
        <div id={carouselId} className="carousel slide position-relative" data-bs-ride="carousel">
            ...
            <div className="position-absolute top-50 translate-middle-y"  id='prevArrow'>
                <a
                    role="button"
            ...
            <div className="position-absolute top-50 translate-middle-y" style={{right: '5%'}} id='nextArrow'>
                <a
                    role="button"
                    data-bs-target={`#${carouselId}`}
                    data-bs-slide="next"
